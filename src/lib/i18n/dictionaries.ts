...
export const dictionaries = {
    en: {
        ...
        statusDone: "Done",
        statusPendingCount: "{count} pending",
        statusPaidCount: "{paid}/{total} paid",
        confirmRequestSent: "Confirmation request sent to payer. Waiting for approval.",
        cancelPaymentPermissionDenied: "You do not have permission to cancel this payment confirmation!",
    ...
    vi: {
        ...
        sharedLabel: "Chung",
        privateLabel: "Riêng",
        untitledExpense: "Khoản chi chưa đặt tên",
        paidByLabel: "Người trả",
        beneficiariesLabel: "Người thụ hưởng",
        amountColumnLabel: "Số tiền",
        statusDone: "Hoàn tất",
        statusPendingCount: "{count} chờ duyệt",
        statusPaidCount: "{paid}/{total} đã trả",
        confirmRequestSent: "Đã gửi yêu cầu xác nhận đến người trả. Đang chờ duyệt.",
        cancelPaymentPermissionDenied: "Bạn không có quyền hủy xác nhận thanh toán này!",
        permissionDeniedMessage: "Bạn không có quyền thực hiện thao tác này",
